...
const myEmployeesAddresses = _.map(myEmployees, e => e.address); // use map to get addresses here.


// Now we want to use map to get an array of ages of the employees.

const myEmployeesAges = _.map(myEmployees, e => e.age); // use map to get ages here.
...
// Bonus Points
const totalByMonth = _.reduce(purchasesByMonth, (total, num) => console.log(purchasesByMonth.Januray) || total + num.price, 0); // Use the grouped purchasesByMonth and reduce to create a totalByMonth object.
